...
export const Success = () => {
  return (
    <div className="w-11/12 md:w-10/12 mx-auto my-10 lg:my-20">
      ...
      ></Title>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 justify-between items-center">
        <div className="flex items-center bg-mutedRose px-12 py-6 gap-4 w-full md:w-auto md:h-[150px]">
        ...
        <div className="flex items-center bg-mutedRose px-12 py-6 gap-6 w-full md:w-auto md:h-[200px]">
        ...
        <div className="flex items-center bg-mutedRose px-12 py-6 gap-4 w-full md:w-auto md:h-[200px]">
